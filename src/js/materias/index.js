...
const guardar = async (evento) => {
  ...
  const url = "/final_IS2_cornelio/API/materias/guardar";
  const config = {
    method: "POST",
    body,
  };
...
const buscar = async () => {
  ...
  const url = `/final_IS2_cornelio/API/materias/buscar?ma_nombre=${ma_nombre}`;
  const config = {
    method: "GET",
  };
...
const modificar = async () => {
  ...
  const body = new FormData(formulario);
  const url = "/final_IS2_cornelio/API/materias/modificar";
  const config = {
    method: "POST",
    body,
  };
...
const eliminar = async (id) => {
  if (await confirmacion("warning", "¿Desea eliminar este registro?")) {
    ...
    const url = "/final_IS2_cornelio/API/materias/eliminar";
    const config = {
      method: "POST",
      body,
    };
