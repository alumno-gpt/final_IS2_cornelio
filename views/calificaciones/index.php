...
<div class="row justify-content-center mb-5">
    <form class="col-lg-8 border bg-light p-3" id="formularioCalificaciones">
        ...
        <div class="col m-3">
            ...
            <input type="number" step="any" name="calif_punteo" id="calif_punteo" class="form-control"
                placeholder="ejemplo: 75.50">
        </div>

        <div class="row mb-3">
            <div class="col">
                <button type="submit" form="formularioCalificaciones" id="btnGuardar" data-saludo="hola"
